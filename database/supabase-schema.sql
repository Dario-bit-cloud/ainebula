-- ============================================
-- Schema Database Supabase per Nebula AI
-- ============================================
-- Esegui questo script nel SQL Editor di Supabase
-- Dashboard Supabase > SQL Editor > New Query > Incolla questo script > Run
-- ============================================
...
-- Tabella per le chat (CRONOLOGIA CHAT)
...
-- Tabella per i messaggi (MESSAGGI DELLE CHAT)
...
-- Tabella per gli abbonamenti (deprecata - ora usa Clerk Billing)
...
-- FINE SCRIPT
-- ============================================
-- Dopo aver eseguito questo script, verifica le tabelle create:
