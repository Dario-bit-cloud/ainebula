// API Route per eliminare un link condiviso su Vercel
...
export default async function handler(req, res) {
  ...
  // Il nome del file [linkId].js diventa un parametro query
  const linkId = req.query.linkId || req.query.id;

  try {
    // DELETE - Elimina un link condiviso
